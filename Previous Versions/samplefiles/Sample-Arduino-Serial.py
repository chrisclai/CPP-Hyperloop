# Sample data code to read in Arduino data into Python
# Will look into purchasing arduino to tinker around with the settings and make sure the code runs properly.
